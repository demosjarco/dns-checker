/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ce34f1550080967bf025fb9cef094296)
// Runtime types generated with workerd@1.20260617.1 2026-06-17 enable_request_signal,global_fetch_strictly_public,nodejs_compat,request_signal_passthrough
interface __BaseEnv_Env {
	PROBE_DB: D1Database;
	NODE_ENV: 'production';
	SQL_TTL: '3600';
	CF_API_TOKEN: string;
	LOCATION_TESTER: DurableObjectNamespace<import('./src/entry.cloudflare-workers').LocationTester>;
	UPDATE_IATAS: Workflow<Parameters<import('./src/entry.cloudflare-workers').UpdateIatas['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/entry.cloudflare-workers');
		durableNamespaces: 'LocationTester';
	}
